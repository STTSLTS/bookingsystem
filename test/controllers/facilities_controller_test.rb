...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { facility_id: @facility.facility_id, facility_name: @facility.facility_name, facility_type: @facility.facility_type } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { facility_id: @facility.facility_id, facility_name: @facility.facility_name, facility_type: @facility.facility_type } }
